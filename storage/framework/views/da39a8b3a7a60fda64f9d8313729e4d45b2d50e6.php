...
<div class="ibox">
    <div class="ibox-content">
        ...
        <div class="table-responsive">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo e($write->id); ?></td>
                        <td><?php echo e($write->user->info->nickname); ?></td>
                        <td><?php echo e($write->user->username); ?></td>
                        <td><?php echo e($write->number); ?></td>
                        <td><?php echo e($write->created_at); ?></td>
                    </tr>
        ...
        <div class="text-right">
            <?php echo e($writes->appends(['nickname'=>Request::get('nickname')])->links()); ?>
