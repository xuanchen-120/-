...
<form action="" method="get" accept-charset="utf-8">
    <div class="login_container" id="register">
        ...
        <div class="login-btm">
            <span class="login-left" @click="window.location.href = '<?php echo e(route('login')); ?>'">密码登录</span>
        </div>
    </div>
    ...
    var app = new Vue({
        ...
        methods: {
            sendSmsCode: function() {
                $.post("<?php echo e(route('auth.sms')); ?>", {mobile: this.mobile, channel: "DEFAULT", '_token': '<?php echo e(csrf_token()); ?>'}, function(res) {
