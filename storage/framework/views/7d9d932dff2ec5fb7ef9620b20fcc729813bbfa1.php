...
<!-- 登录 Start -->
<form action="<?php echo e(route('mydata.year')); ?>" method="POST" accept-charset="utf-8">
    <div class="login_container" >
        <div class="login_block login_margin">
            <i class="icon icon-file-word login_i" style="font-size:1rem"></i>
            <input type="number" name="number" value="" placeholder="<?php echo e($placeholder ?? ''); ?>" class="input login_input" >
            <input type="hidden" name="type" value="<?php echo e(Request::get('type')); ?>">
            <input type="hidden" name="user_id" value="<?php echo e($user->id); ?>">
            <input type="hidden" name="channel" value="year">
        </div>
        <?php echo csrf_field(); ?>
