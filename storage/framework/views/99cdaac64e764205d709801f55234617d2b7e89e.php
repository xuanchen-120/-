...
<section class="padding_btm" >
    <!-- 提现表单 Start -->
    <form action="<?php echo e(route('chant.reportdo')); ?>" method="POST" accept-charset="utf-8">
        <div class="formbox">
        ...
        <div class="formbox">
            ...
            <div class="formbox-input">
                <input type="number" name="number" value="" placeholder="输入诵经数" class="formbox-input-text">
            </div>
        </div>
