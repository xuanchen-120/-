...
<form action="<?php echo e(route('write.edit',$write)); ?>" method="POST" accept-charset="utf-8">
    <div class="login_container" >
        <div class="login_block login_margin">
            <i class="icon icon-file-word login_i" style="font-size:1rem"></i>
            <input type="tel" name="number" value="<?php echo e($write->number); ?>" placeholder="请输入抄经次数" class="input login_input" >
        </div>
        <?php echo csrf_field(); ?>
