...
<section class="padding_btm" id="app" >
    ...
    <ul class="bi-list" style="background:none">
        ...
        <li style="background-color: #fff;padding: .6rem 0">
            <div class="record_block">
                <div class="bi-list-r bi-list-small"><?php echo e($chant_data['today']); ?></div>
                <div class="bi-list-l bi-list-small"><?php echo e($chant_data['month']); ?></div>
                <div class="bi-list-r bi-list-small"><?php echo e($chant_data['year']); ?></div>
                <div class="bi-list-r bi-list-small"><?php echo e($chant_data['all'] + $data['all_chant']); ?></div>
            </div>
        </li>
    </ul>
    <!--end 记录-->
    ...
    <div class="accounts_detail">
        <div class="j_withdraw_btn1" data-href="<?php echo e(route('chant.report')); ?>">报数</div>
        诵经明细
    </div>
    <ul class="bi-list" style="background:none" id="list">
        <?php if($chants->count() > 0): ?>
        <?php echo $__env->make('chant.list', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<script type="text/javascript">
    ...
    var refreshBox = new PullToRefresh({
        ...
        up:{
            callback:function(){
                setTimeout(function(){
                    if (page < <?php echo e($chants->lastPage()); ?>) { //执行page次加载
                        page++
                        $.get("<?php echo e(route('chant.more')); ?>",{page:page},function(res){
