...
<form action="<?php echo e(url()->current()); ?>" method="POST" accept-charset="utf-8">
    <div class="login_container" id="bycode">
        ...
        <div class="login-btm">
            ...
            <span class="login-right" @click="window.location.href = '<?php echo e(route('login')); ?>'">密码登录</span>
        </div>
    </div>
    ...
    var app = new Vue({
        ...
        methods: {
            sendSmsCode: function() {
                $.post("<?php echo e(route('auth.sms')); ?>", {mobile: this.mobile, channel: "BYCODE", '_token': '<?php echo e(csrf_token()); ?>'}, function(res) {
